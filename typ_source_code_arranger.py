...
def put_typ_content(dest_file, source_code, question_name, question_template, dest_dir):
...
def typ_source_arranger(source_dir, dest_dir, output_file_name, template_file):
    ...
    for source_file in source_files:
        if source_file.endswith(".py"):
            ...
            put_typ_content(output_file_name, source_code, question_name, template_file, dest_dir)
